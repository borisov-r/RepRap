...
//      #endif
  ...
  if (current_block != NULL) {
    ...
    if (step_events_completed >= current_block->step_event_count) {
      // If RepRap is used as EM3Dscanner it will print following text
      // after the move is finished. To enable this feature uncomment
      // "#define EM3Dscanner // enable EM3Dscanner mode" line in Configuration.h
      #ifdef EM3Dscanner
