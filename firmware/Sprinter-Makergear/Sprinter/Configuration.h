...
#define _AXIS_STEP_PER_UNIT {104.987, 104.987, 2580.9588, 1487}  // calibrated settings for X, Y, Z - Makergear @ work
...
// Uncomment following line to enable RepRap to be used as EM3Dscanner
#define EM3Dscanner // enable EM3Dscanner mode
